...
public class CreateGestureActivity extends Activity {
    ...
    // This function sends data which was saved in 'toArduino'list to Arduino
    public void sendGesture(int[] toArduino) throws IOException {
    	// 1. Set up my Bluetooth
    	POEBluetoothAdaptor bluetooth = new POEBluetoothAdaptor();
        Toast.makeText(this, bluetooth.mStatus, Toast.LENGTH_SHORT).show();
        
    	// 2. Set up connection with Arduino
        bluetooth.connect();
        Toast.makeText(this, bluetooth.connection_status , Toast.LENGTH_SHORT).show();
    	// 3. Send
        bluetooth.send(toArduino);
        Toast.makeText(this, bluetooth.Socket_connection_status , Toast.LENGTH_SHORT).show();
        Toast.makeText(this, bluetooth.Sending_status , Toast.LENGTH_SHORT).show();
    }
    
    // This function add gesture that user drew and read through the line.
    @SuppressWarnings({"UnusedDeclaration"})
    public void addGesture(View v) throws IOException {
        ...
        if (mGesture != null) {
            ...
            // Initialize the array (of length 225) with all 0s.
            final int SCREEN_WIDTH = 12;
            final int SCREEN_HEIGHT = 15;
            ...
            // Convert storke points to toArduino array with 180 integers
